        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="{{route('admin.proudect.table_prod')}}">
                        <!-- Logo icon -->
        ...
        <ul aria-expanded="false" class="collapse first-level">
            ...
            <li class="sidebar-item">
                ...
                class="hide-menu">Archive</span></a>
                    ...
                    <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="mdi mdi-view-list"></i><span class="hide-menu">Categorys
                                </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.category.table_catg')}}" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
                                            class="hide-menu"> All Categorys </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.category.create_catg')}}" class="sidebar-link"><i class="mdi mdi-plus-box"></i><span
                                        class="hide-menu"> Add Category </span></a>
                                    </li>

                                <li class="sidebar-item">
                                    <a href="{{ route('admin.category.archive')}}" class="sidebar-link"><i class="mdi mdi-archive"></i><span
                                        class="hide-menu"> Archive </span></a>
                                    </li>
                    </ul>
